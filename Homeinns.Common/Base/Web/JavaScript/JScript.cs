...
namespace Homeinns.Common.Base.Web.JavaScript
{
    ...
    public class JScript
    {
        ...
        {
            var js = String.Format(@"<Script language='JavaScript'>window.open('{0}','','height={1},width={2},top={3},left={4},location=no,menubar=no,resizable=yes,scrollbars=yes,status=yes,titlebar=no,toolbar=no,directories=no'');</Script>", url, heigth, width, top, left);
