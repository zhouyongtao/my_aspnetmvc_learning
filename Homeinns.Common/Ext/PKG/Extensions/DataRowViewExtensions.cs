...
public static class DataRowViewViewExtensions
{
    ...
    /// <param name="field">The name of the record field.</param>
    /// <returns>The record value</returns>
    public static T GetTypeInstance<T>(this DataRowView row, string field)
        where T: class
    {
    ...
    /// <returns>The record value</returns>
    public static T GetTypeInstanceSafe<T>(this DataRowView row, string field, Type type)
        where T: class
    {
    ...
    /// <param name="field">The name of the record field.</param>
    /// <returns>The record value</returns>
    public static T GetTypeInstanceSafe<T>(this DataRowView row, string field)
        where T: class, new()
    {
        var instance = (row.GetTypeInstance(field, null) as T);
